...
/**
 * Control of values in containers(prefixes, suffixes, etc).
 */
public class ForecastValueControl extends Pane {
    ...
    private ObjectProperty<Observable<RawForecastEvent>> sourceProperty = new SimpleObjectProperty<>();
    ...
    public Observable<RawForecastEvent> getSource() {
        return sourceProperty.get();
    }

    public void setSource(Observable<RawForecastEvent> source) {
        source.subscribe(e -> {
