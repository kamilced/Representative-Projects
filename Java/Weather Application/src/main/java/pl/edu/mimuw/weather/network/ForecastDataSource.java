...
public abstract class ForecastDataSource {

    /**
     * *****Borrowed from XChangeApp, really useful*****
     */
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ForecastDataSource.class);
    ...
    /**
     * Merge two ways of getting data (refresh button + each pollInterval).
     */
    ...
    /**
     * It makes request for data, each class which extends this method is responsible for
     * making request from different source of data.
     */
    protected abstract Observable<? extends ForecastEvent> makeRequest();
