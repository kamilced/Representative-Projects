...
/**
 * Kind of feature in weather app, no one has it.
 * ****Borrowed from XApp****
 */
public class ForecastTooltip extends StackPane {

    private Observable<RawForecastEvent> source;

    private RawForecastEvent lastEvent;
    ...
    public ForecastTooltip(Observable<RawForecastEvent> source, String title) {
        this.source = source;
    ...
    private Text createTimestampText(Observable<RawForecastEvent> source) {
